        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {games.map((game, i) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-slate-100 dark:bg-zinc-900/50 rounded-2xl overflow-hidden border border-slate-200 dark:border-zinc-800 group hover:border-slate-300 dark:border-zinc-700 transition-all duration-300"
            >
