  ...
  return (
    <div className="pt-24 pb-24 px-6 max-w-4xl mx-auto min-h-screen">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-zinc-900 dark:text-zinc-100 mb-6">个人随笔</h1>
        ...
        <div className="space-y-8">
          {posts.map((post, i) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="p-8 md:p-10 bg-slate-100 dark:bg-zinc-900/50 rounded-3xl border border-slate-200 dark:border-zinc-800 hover:bg-slate-100 dark:bg-zinc-900 hover:border-slate-300 dark:border-zinc-700 hover:-translate-y-1 transition-all duration-300 cursor-pointer group"
            >
