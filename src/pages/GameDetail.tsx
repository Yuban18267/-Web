...
export default function GameDetail() {
  ...
  if (!game) {
    return (
      <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto min-h-screen text-center">
        <h2 className="text-2xl font-bold text-slate-800 dark:text-zinc-100 mb-4">游戏记录未找到</h2>
        <Link to="/game" className="text-blue-600 hover:underline inline-flex items-center gap-2">
  ...
  return (
    <div className="pt-24 pb-24 px-6 max-w-5xl mx-auto min-h-screen">
      ...
      >
        <Link to="/game" className="inline-flex items-center gap-2 text-slate-500 hover:text-blue-600 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors mb-8 font-medium">
          <ArrowLeft size={16} /> 返回游戏列表
        </Link>
