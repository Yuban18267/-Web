    ...
    <div className="relative">
      <div className="pl-6 md:pl-12 lg:pl-24 pr-6 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="hidden md:flex items-center gap-3 pr-12 pb-2">
          <button
            onClick={scrollLeft}
            className="w-12 h-12 rounded-full border border-slate-200 dark:border-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-zinc-800 transition-colors"
          >
            <ArrowLeft size={20} />
          </button>
          <button
